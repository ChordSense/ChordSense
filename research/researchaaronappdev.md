# ChordSense Companion App Research
...
This research helped show that a companion app could be added without changing the core design of ChordSense. The app would serve as an additional way for users to interact with the system.

## Key Takeaways

- A cross-platform app would support both Android and iPhone.
- Flutter and React Native are both reasonable options.
- Bluetooth works well for smaller control-related communication.
- Larger audio transfers may work better through a local network connection.
